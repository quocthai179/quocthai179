...
- 🏠 Running a **homelab** with Docker Compose, Cloudflare Tunnel, n8n and local LLMs, switch, AP and ESP32
- 💬 Ask me about **IT**
- ⚡ Fun fact: **I play piano — and Vietnamese Catholic hymns**
...
![SNMP](https://img.shields.io/badge/SNMP%20%2F%20MIB-1F6FEB?style=for-the-badge)
...
|---------|-------------|-------|
| **Miber** | Model Context Protocol server exposing SNMP walk/get operations to LLM agents | `Java` `MCP` `SNMP4J` |
| **Izar** | ESP32 IoT fleet management — device provisioning | `ESP32` |
...
<img height="165" src="https://github-readme-stats.vercel.app/api?username=YOUR_USERNAME&show_icons=true&theme=tokyonight&hide_border=true&count_private=true&include_all_commits=true" alt="GitHub Stats" />
...
<img src="https://github-profile-trophy.vercel.app/?username=YOUR_USERNAME&theme=tokyonight&no-frame=true&no-bg=true&column=7&margin-w=8" alt="Trophies" />
...
🔨 Building   →  MCP servers for network engineering workflows
🎯 Learning   →  Advanced system design, English for technical communication
🐟 Side quest →  Automating my ranchu goldfish tank with ESP32 sensors
```
...
When I'm not debugging Kafka consumer lag, you'll find me:

- 🎷 Playing **piano**
- 🐟 Keeping **ranchu goldfish** — surprisingly similar to running a production system: monitor the metrics, don't over-optimize
- 🎮 Playing **Oxygen Not Included** (yes, it's basically distributed systems with duplicants)
